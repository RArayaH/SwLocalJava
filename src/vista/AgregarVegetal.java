 ...
 */
public class AgregarVegetal extends javax.swing.JInternalFrame {

    /**
     * Creates new form AgregarProducto
     */
    public AgregarVegetal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar Vegetal");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(jText_Peso, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
    ...
    private void jB_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_AgregarActionPerformed
        try {
            Vegetal objVeg = new Vegetal(this.jText_Peso.getText(),this.jText_Nombre.getText(),this.jText_Codigo.getText(),Integer.parseInt(this.jText_Precio.getText()));
            objVeg.cargarCodigoProducto();
            if (Conexion.buscarProducto) {
                System.out.println("El Vegetal ya existe");
                JOptionPane.showMessageDialog(null,"Vegetal ya existe!" ,"Guardar", 0);
                objVeg.imprimir();
            }
            else{
                objVeg.guardarVegetal();
