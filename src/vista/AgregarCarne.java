 ...
 */
public class AgregarCarne extends javax.swing.JInternalFrame {
    ...
    private void jB_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_AgregarActionPerformed
        ...
        try {
            Carne objCar = new Carne(this.jText_Peso.getText(),this.jText_Nombre.getText(),this.jText_Codigo.getText(),Integer.parseInt(this.jText_Precio.getText()));
            objCar.cargarCodigoProducto();
            if (Conexion.buscarProducto) {
                System.out.println("La Carne ya existe");
                JOptionPane.showMessageDialog(null,"La Carne ya existe!" ,"Guardar", 0);
                objCar.imprimir();
            }
            else{
                objCar.guardarCarne();
